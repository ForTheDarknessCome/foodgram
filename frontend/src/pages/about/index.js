    ...
    <Container>
      ...
      <div className={styles.content}>
        <div>
          ...
          <div className={styles.text}>
            <p className={styles.textItem}>
              Представляю вам проект, созданный во время обучения в Яндекс Практикуме. Этот проект — часть учебного курса, созданный самостоятельно с 0.
            </p>
            <p className={styles.textItem}>
        ...
        <aside>
          ...
          <div className={styles.text}>
            <p className={styles.textItem}>
              Код проекта находится тут - <a href="https://github.com/ForTheDarknessCome/foodgram" className={styles.textLink}>Github</a>
            </p>
            <p className={styles.textItem}>
              Автор проекта: <a href="https://github.com/ForTheDarknessCome" className={styles.textLink}>Github</a>
            </p>
          </div>
        </aside>
      </div>
